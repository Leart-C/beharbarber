...
export const translations = {
  sq: {
    ...
    profile: {
      title: "Profili",
      description: "Menaxho llogarinë dhe preferencat.",
      ...
      noContactInformation: "Informacionet e kontaktit nuk janë caktuar ende.",
      linkErrorTitle: "Lidhja nuk u hap",
      linkErrorMessage: "Nuk mundëm ta hapnim këtë lidhje. Provo përsëri.",
      businessLoading: "Duke ngarkuar informacionet e biznesit...",
  ...
  en: {
    ...
    profile: {
      ...
      noContactInformation: "Contact information has not been configured yet.",
      linkErrorTitle: "Link could not be opened",
      linkErrorMessage: "We could not open this link. Please try again.",
